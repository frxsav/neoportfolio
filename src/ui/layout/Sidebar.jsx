export default function Sidebar() {
  return (
    <div className="flex flex-col col-span-3 p-4 bg-primary-strong/90 backdrop-blur-sm rounded-l-xl border-t border-l border-b border-secondary overflow-hidden">
